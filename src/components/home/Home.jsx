...
return (
  ...
  <div>
    ...
    <div className="hero overflow-hidden  h-[85vh] md:px-10 ">
        {/* <img className="w-full h-[90vh]" src="https://i.ibb.co/4TjvGry/5.jpg" alt="" /> */}
      <div className="w-full border h-[80vh] " >
        <div className="hero-content h-[80vh] mx-auto md:flex justify-center items-center  " > 

          <div  data-aos="fade-down" className=" flex-1 ">
            <h1 className="text-6xl font-bold ">Hello there</h1>
            <h1 className="text-4xl pt-1 font-bold">We will make your life easiar</h1>
          ...
          <div data-aos="fade-left" className="flex-1 w-full p-10 grid grid-cols-2 gap-5   h-[80vh]">
...
ড. মোহাম্মদ হেলাল উদ্দিন বলেন, উৎপাদন বেশি হলেও কেউ যদি তা বিক্রি করতে না চায়, বরং পরে ভাল দাম পাওয়ার আশায় ধরে রাখে তাহলে বেশি চাহিদার কারণে সেই পণ্যের দাম বেড়ে যায়।
 ...
 <div className='flex p-3 '>
    <div className='space-y-3 pr-8'>
    <h2 className='text-xl font-bold'>নিত্যপ্রয়োজনীয় পণ্য নিশ্চিত করতে সরকারিভাবে টিসিবির মাধ্যমে খোলাবাজারে পণ্য বিক্রি করা হচ্ছে</h2>
    <p className='overflow-hidden h-[230px] leading-8'>
    বাংলাদেশে গত এক বছরে চাল ও আটার মতো পণ্যের দাম না বাড়লেও শুধু অক্টোবরেই খাদ্য মূল্যস্ফীতি বেড়ে সর্বোচ্চ হয়েছে। কৃষি ও বাজার বিশ্লেষকরা বলছেন, দাম বাড়ার কারণ হিসেবে বেশিরভাগ সময় সিন্ডিকেটের দিকে আঙুল তোলা হলেও এর পেছনে আরও বেশ কিছু কারণ রয়েছে।

কারণ অনেক সময় উৎপাদন বেশি হলেও বাজারে ঠিকমতো সরবরাহ হয় না। আবার উৎপাদন ও আমদানি খরচ বেড়ে যাওয়ার প্রভাবও পড়েছে অনেক পণ্যের দামে। সরকারি যেসব তথ্য দেয়া হয়, সেখানেও প্রকৃত অবস্থার সাথে তারতম্য থাকে।

যদিও বিশ্লেষকদের অনেকে বাজারে দ্রব্যমূল্য বৃদ্ধির পেছনে শুধু সিন্ডিকেটকে দায়ী করতে চান না, তবে এ নিয়ে বাংলাদেশে নিত্যপ্রয়োজনীয় দ্রব্যের দাম বৃদ্ধির পেছনে সিন্ডিকেট বা ব্যবসায়ীদের কারসাজিকে বিভিন্ন সময় দায়ী করা হয়েছে ভোক্তা অধিকার সংগঠন ও সরকারের কর্মকর্তাদের পক্ষ থেকে।

গত ২৬শে জুন সংসদ অধিবেশন চলাকালে বাণিজ্যমন্ত্রী টিপু মুনশি দ্রব্যমূল্যের ঊর্ধ্বগতি ও সিন্ডিকেট নিয়ন্ত্রণে ব্যর্থতার অভিযোগে জাতীয় সংসদে বিরোধী দলের নেতাদের কঠোর সমালোচনা ও ক্ষোভের মুখে পড়েছিলেন।
    </p>
    <p className='text-teal-500 font-bold text-sm underline '>৩ ঘণ্টা আগে</p>
    </div> 
    <img className='w-[400px] h-[300px]' src="https://ichef.bbci.co.uk/news/800/cpsprodpb/dfe0/live/a550ec90-7d6f-11ee-a503-4588075e3427.jpg" alt="" />
  </div> 

 <div className='flex p-3 my-10 '>
    <img className='w-[400px] h-[300px]' src="https://ichef.bbci.co.uk/news/800/cpsprodpb/238f/live/64279a70-7d65-11ee-b556-9787f91d41cc.jpg" alt="" />
    <div className='space-y-3 pl-8'>
    <h2 className='text-xl font-bold'>ব্রয়লার মুরগি ও ডিম-দুটোরই দাম বেড়েছে</h2>
    <p className='overflow-hidden h-[230px] leading-8'>
    টিসিবির তথ্য অনুযায়ী, গত এক বছরে প্রতি হালি ডিমের দাম শতকরা ৫.২৬ শতাংশ বেড়েছে। গত বছর এক হালি ডিমের দাম ছিল সর্বোচ্চ ৫০ টাকা। বর্তমানে এটি ৫২ টাকা দরে বিক্রি হচ্ছে। তবে স্থানীয় সংবাদ মাধ্যমগুলোতে চলতি বছর ডিম প্রতি ডজন ১৬০থেকে ১৬৫ টাকায়ও বিক্রি হওয়ার খবর পাওয়া গেছে প্রাণী সম্পদ অধিদপ্তরের তথ্য অনুযায়ী, ২০২২-২৩ অর্থবছরে দেশে ডিমের চাহিদা এক হাজার ৮০৬ কোটি পিস। উৎপাদন হয়েছে দুই হাজার ৩৩৮কোটি পিস। সংস্থাটির তথ্য অনুযায়ী, ডিম ও মাংসের উৎপাদন গত অর্থবছরে চাহিদার তুলনায় বেশি উৎপাদিত হয়েছে। অর্থনীতিবিদরা বলছেন, ডিম একটা পচনশীল দ্রব্য। সেটা ধরে রাখা যায় না। তাই উৎপাদন হলেও সেটা কতদিনের জন্য হয়েছে সেটা জরুরি। ডিমের দাম কমাতে এরই মধ্যে ডিম আমদানির অনুমোদন দিয়েছে সরকার। ভারত থেকে বাংলাদেশে ডিম আসতেও শুরু করেছে।
    </p>
